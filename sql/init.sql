...
(
    ...
    status      int      default 1                 null comment '事项处理状态:1-未进行，2-已实行，3-超时',
    ...
    if_private  int      default 1                 null comment '是否私人：1-私人，2-公开',
...
(
    ...
    level       int      default 3                 null comment '日程重要程度',
    start_day   int                                null comment '星期：1-星期一，7-星期日',
...
(
    ...
    unionid         varchar(255)                       null comment '平台用户唯一id',
...
(
    ...
    level          varchar(50) default 'lv1'             null comment '段位',
...
--  data
-- ------------------
insert into user (id, username, img_url, unionid, openid)
VALUES (1, '1', '1', '1', '1');
insert into schedule_temp (id, user_id, task_id, task_name, status, level, start_time)
VALUES (1, 1, 1, '1', 1, 1, '2020-02-02 11:11:11');
insert into schedule_weekly (id, user_id, task_id, task_name, status, level, start_day, start_time)
VALUES (1, 1, 2, '1', 1, 1, 1, '10:10:10');